...
export function MetricCard({
  ...
  return (
    <article className="reveal-card rounded-[28px] border border-borderGlass bg-panel/80 p-5 shadow-glass backdrop-blur-xl">
      <div className="mb-4 flex items-start justify-between">
        ...
        <div
          className="grid h-11 w-11 place-items-center rounded-2xl border border-white/10 text-ink"
